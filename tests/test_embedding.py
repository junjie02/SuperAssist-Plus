...
from superassist.memory.embedding import BGEEmbedder, HashEmbedder, create_embedder
...
def test_create_embedder_uses_bge_provider() -> None:
    settings = Settings(
        SUPERASSIST_EMBEDDING_PROVIDER="bge",
        SUPERASSIST_EMBEDDING_MODEL="BAAI/bge-base-zh-v1.5",
        SUPERASSIST_EMBEDDING_DEVICE="cpu",
    )
